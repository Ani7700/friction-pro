...
const Essay = (props: EssayProps) => {
  ...
  const [orthographySpans, setOrthographySpans] = useState<SpanData[]>([]);
  const [organizationSpans, setOrganizationSpans] = useState<SpanData[]>([]);
  const [wordUsageSpans, setWordUsageSpans] = useState<SpanData[]>([]);
  ...
  useEffect(() => {
    const updateSpansPosition = (category?: Category) => {
      ...
      if (category === "orthography") setOrthographySpans(spansData);
      if (category === "organization") setOrganizationSpans(spansData);
      if (category === "word-usage") setWordUsageSpans(spansData);
    };
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="text-base leading-8 pl-8 pr-56 overflow-y-auto relative grow"
      >
                  ...
                  </span>
                  {
                    ...
                    >
                      ...
                      <FeedbackDistributionVis
                        ...
                        orthographySpans={orthographySpans}
                        organizationSpans={organizationSpans}
                        wordUsageSpans={wordUsageSpans}
